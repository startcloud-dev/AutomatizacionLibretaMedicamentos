...
public class LoginDoctor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String rut = new DoctorDaoImp().validarRut(rute, pass);
            String password = new DoctorDaoImp().validarPass(pass, rut);
            String usuario = new DoctorDaoImp().recuperarNombre(rut);
            ...
            if (!rute.equals(rut) && !pass.equals(password) && sesion.getAttribute("usuario") != null) {
                ...
                request.setAttribute("mensaje", "Bienvenido Doctor "
                        + usuario);
                request.getRequestDispatcher("Inicio_Doctor.jsp").
                        forward(request, response);
            }
        }
    }
