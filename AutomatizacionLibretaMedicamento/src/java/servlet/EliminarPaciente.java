...
public class EliminarPaciente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String mensaje = "";
           if(new dao.PacienteDaoImp().eliminar(dto)){
               
               mensaje = "Paciente eliminado";
           }else{
               
               mensaje = "Paciente no eliminado";
           }
          request.setAttribute("mensaje", mensaje);
          request.setAttribute("lista",  new dao.PacienteDaoImp().listar());
          
          request.getRequestDispatcher("Paciente/EliminarPaciente.jsp").forward(request, response);
        }
    }
