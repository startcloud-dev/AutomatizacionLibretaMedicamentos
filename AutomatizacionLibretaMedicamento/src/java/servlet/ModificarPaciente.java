...
public class ModificarPaciente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            dto.setApellido_materno(request.getParameter("txtApellidoPat".trim()));
            dto.setDireccion(request.getParameter("txtDireccion".trim()));
            dto.setTelefono(request.getParameter("txtTelefeno".trim()));
            dto.setCorreo(request.getParameter("txtCorreo".trim()));
            dto.setFecha_nacimiento(Date.valueOf(request.getParameter("txtFechaNacimientoFF")));

            String mensaje="";
            if (new dao.PacienteDaoImp().modificar(dto)) {
